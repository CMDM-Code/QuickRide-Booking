          ...
          <div className="relative z-10 flex flex-col justify-center px-16 py-20">
            <div className="space-y-8">
              <div className="text-green-400 font-semibold text-sm uppercase tracking-wider">
                Experience The Kinetic Gallery
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">
                Access your curated fleet of high-performance vehicles and personalized driving experiences.
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/auth/reset-password" className="text-sm text-green-700 font-medium hover:underline">
                    Forgot Password?
                  </Link>
                </div>
                <input
