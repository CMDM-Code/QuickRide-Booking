    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 font-medium mt-1">Manage your alerts and stay updated with your bookings.</p>
        </div>
      ...
      {notifications.length === 0 ? (
        <div className="bg-white rounded-[2rem] shadow-sm border border-slate-100 p-20 text-center">
          ...
          <p className="text-slate-500 font-medium max-w-sm mx-auto">
            When we have updates about your bookings or special offers, they'll show up here.
          </p>
        </div>
      ) : (
